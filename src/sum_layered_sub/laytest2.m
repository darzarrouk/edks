...
dip    = [60.0 30.0];   %deg
rake   = [90.0 90.0];   %deg
slip   = [5e0 0.5e2]; %meters
L      = [3e3 0.5e3]; %meters, along strike
W      = [1e3 0.5e3]; %meters, down dip

xs     = [1.0e3 1.0e3]; %middle of top edge of fault
ys     = [1.0e3 2.0e3]; %middle of top edge of fault
zs     = [1.0e3 1.0e3]; %middle of top edge of fault
...
dtime = etime(time2, time1)
disp(['elapsed time: ' num2str(dtime) ' sec']);
