...
"""
    ...
    Revision History:
    - Mar 2014: Adding options fault_strike, fault_strike_delta, w_ascii, w_bin (Z. Duputel)
    - Jul 2016: Python3 compatibility (T. Ragon)
...
if __name__ == '__main__':
   ...
   calcGreenFunctions_EDKS_PwlSubTriangles(sp.TriPropFile, sp.TriPointsFile, sp.ReceiverFile,\
                                         sp.method_par, sp.plotGeometry)
